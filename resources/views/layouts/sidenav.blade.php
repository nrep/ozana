        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            @can('view products')
                <li class="nav-item" {{ Request::segment(1) == 'products' ? 'active' : '' }}>
                    <a href="/products" class="nav-link d-flex justify-content-between">
                        <span>
            ...
            @can('view stock items')
                <li class="nav-item" {{ Request::segment(1) == 'stock' ? 'active' : '' }}>
                    <a href="/stock" class="nav-link d-flex justify-content-between">
                        <span>
                            <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor"
                                    viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse" role="list" id="submenu-pages" aria-expanded="false">
                    <ul class="flex-column nav">
                        @can('view purchases and expenses report')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('purchases-and-expenses') }}">
                                    <span class="sidebar-text">Purchases & Expenses</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @can('view income vs expenses report')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('income-vs-expenses') }}">
                                    <span class="sidebar-text">Income vs Expenses</span>
                                </a>
                            </li>
                        @endcan
                        @can('view expiry report')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('expiry-report') }}">
                                    <span class="sidebar-text">Expiry Report</span>
                                </a>
                            </li>
                        @endcan
                        @can('view stock value report')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('stock-value') }}">
                                    <span class="sidebar-text">Stock Value</span>
                                </a>
                            </li>
                        @endcan
                    </ul>
