...
class Item extends Component
{
    ...
    public function mount() {
        ...
        $this->unit_price = $this->item->stock->selling_price;
        $this->available_quantity = $this->item->stock->available_quantity;
        $this->order_quantity = $this->item->quantity;
        $this->price = $this->order_quantity * $this->unit_price;
    }

    public function render()
    {
        return view('livewire.order.update.item');
    }
